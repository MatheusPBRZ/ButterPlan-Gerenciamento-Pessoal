...
![Capa do Projeto](link-para-uma-screenshot-bonita-do-dashboard.jpg)
...
- **Gestão Hierárquica de Tarefas:** Crie projetos macro e quebre-os em subtarefas infinitas para facilitar a execução.
- **Sincronização Bidirecional:** Conectado nativamente à API do Google Calendar. Criou ou apagou no ButterPlan? O seu celular apita atualizado na mesma hora.
- **Tarefas Recorrentes:** Automação de rotinas em dias específicos da semana.
- **Controle Financeiro Integrado:** Acompanhamento de saldo, fluxo de caixa, despesas fixas (com lembretes automáticos) e gestão inteligente de parcelamentos.
...
👉 **[Ler a Documentação Técnica Completa (Deep Dive) da Arquitetura do ButterPlan](./DOC_TECNICA.md)**

---
*Desenvolvido com ☕ e foco por [Seu Nome/Matheus].*